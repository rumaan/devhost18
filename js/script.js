...
(function ($) {
    ...
    if (o.length && page.hasClass("page-complex")) {
        $(document).ready(function () {
            o.each(function () {
                var $this = $(this);
...
//(function ($) {
//    var o = $('html');
//    if (o.hasClass('desktop') && page.hasClass("page-complex")) {
//
//        $(document).ready(function () {
//            $().UItoTop({
        ...
        $(document).ready(function () {
            o.RDNavbar({
                ...
                responsive: {
                    ...
                    1460: {
                        layout: o.attr("data-layout").split(" ")[0]
                    }
                },
                onepage: {
                    enable: false,
...
(function ($) {
    ...
    if ((o.length > 0 || g.length > 0) && page.hasClass("page-complex")) {
